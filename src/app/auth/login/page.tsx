    ...
    <div className="min-h-screen gradient-hero flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          <p className="text-text-secondary text-center mb-8">Sign in to manage your sites</p>
          ...
          <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }} className="space-y-4">
            ...
            <div>
              ...
              <div className="text-right mt-2">
                <Link href="/auth/forgot-password" className="text-sm text-blue hover:underline">Forgot password?</Link>
              </div>
            </div>
          ...
          <p className="text-center text-sm text-text-secondary mt-6">
            ...
            <Link href="/auth/signup" className="text-blue font-medium hover:underline">Sign Up</Link>
          </p>
        </div>
      </div>
    </div>
